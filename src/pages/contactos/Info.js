...
//IMPORT COMPONENTS
import SocialNetworks from "../Layout/Footr/SocialNetworks";
//IMPORT IMAGES
...
const Info = (props)=>{
    ...
    <Modal {...props} size="lg"
      ...
      centered
      >
        <div className="bg-color android-theme"><h2 className="colortheme"><FiAlertTriangle /> MAS INFO...</h2></div>
      <Modal.Body className="text-center bg-color text-light">
          <Row>
            <Col md={4}><h4>Linea de Atenci&oacute;n</h4>
              <h2 className="text-vertical">CONTACTO</h2>
    ...
    <Container>
      ...
      <Modal.Footer>
        <i className="icon"><BsTelephoneOutbound /></i><h6>Haz click en los &iacute;conos o marca directamente la linea de atenci&oacute;n</h6></Modal.Footer>
